...
ncl <- max(centers)
write(x = t1, file = paste0(idx_path, "/time_idx_60k.txt"), append = T)
write_rds(idx, paste0(idx_path, "/idx_", ncl, "k_", cunit, "_", basinID ,
...
fwrite(idx_tbl, paste0(idx_path, "/idx_table_60k_", cunit, "_", basinID ,
                       "_", vset, "_seed", rnum, "_nstart", nstr, ".csv"))
fwrite(sse_dat, paste0(idx_path, "/norm_within_ssq_60k_", cunit, "_", 
                       basinID , "_", vset,"_seed", rnum, "_nstart", nstr, 
                       ".csv"))
